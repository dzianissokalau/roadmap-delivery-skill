...
- Next human action: Review the pushed GitHub branch for promotion readiness; release publication, main promotion, remote schedules, repository secrets, and installed package sync remain separate approvals.
